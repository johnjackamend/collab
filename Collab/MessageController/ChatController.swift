            ...
            if  snapshot.value is NSNull {
                ...
                for key: String in allKeys {
                    ...
                    if senderID == userID || receiverID == userID {
                        ...
                        //let userValue = nodeDict["userData"] as? Dictionary ?? [:]
                        //                        let frinedData = userValue[objChat.friendID] as? Dictionary ?? [:]
                        //                        objChat.friendName = (frinedData["userName"] as? NSString)!
                        //                        objChat.friendImage = frinedData["userImage"] as! NSString
